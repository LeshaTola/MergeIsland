    ...
    public static class DefineSymbols
    {
        ...
        public static void PlatformDefineSymbols()
        {
            ...
            PlayerSettings.SetScriptingDefineSymbols(
                UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup), definesText);
        }
        ...
        public static void AddDefine(string define)
        {
            ...
            PlayerSettings.SetScriptingDefineSymbols(
                UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup), defines + ";" + define);
        }
        ...
        public static void RemoveDefine(string define)
        {
            ...
            if (defines.Contains(define))
            {
                ...
                PlayerSettings.SetScriptingDefineSymbols(
                    UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup), newDefines);
            }
        }
    }
}
