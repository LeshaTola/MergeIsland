...
namespace YG
{
    public partial class InfoYG : ScriptableObject
    {
        ...
        public ProjectSettings platformOptions => Basic.platform.projectSettings;
#if UNITY_EDITOR
        ...
        public static void CleanPlatforms(string ignorePlatform = null)
        {
            ...
            for (int i = 0; i < platfFolders.Length; i++)
            {
                ...
                IEnumerable<string> asmdefFiles = files.Where(file =>
                    Path.GetExtension(file).Equals(".asmdef", StringComparison.OrdinalIgnoreCase));
