...
namespace YG
{
    ...
    {
        public TemplatesSettings Templates = new();
        ...
        public partial class TemplatesSettings
        {
            ...
            public class Gradient
            {
                ...
                public Color color1 = new(1f, 0.831f, 0.149f, 1f);
                public Color color2 = new(0.36f, 0.09f, 1f, 1f);
            }
            ...
            public class ProgressBar
            {
                ...
                public Color color1 = new(0.25f, 0.6392f, 1f, 1f);

                [Tooltip(Langs.t_progressBar_color2)]
                public Color color2 = new(1f, 0.831f, 0.149f, 0.7f);
            }
#if RU_YG2
