...
namespace YG
{
    public partial class InfoYG
    {
        ...
        public static string PATCH_PC_YG2 => Path.Combine(Application.dataPath, CORE_FOLDER_YG2);
        ...
        public static string FILE_MODULES_PC => Path.Combine(PATCH_PC_EDITOR, "ModulesListYG2.txt");

        public static string FILE_SERVER_INFO => Path.Combine(PATCH_PC_EDITOR, "ServerInfoYG2.json");
        ...
        public static string PATCH_PC_EXAMPLE => Path.Combine(PATCH_PC_YG2, "Example");

        public static string PATCH_PC_WEBGLTEMPLATES => Path.Combine(Application.dataPath, "WebGLTemplates");
        ...
        public static string PATCH_PC_ICONS => Path.Combine(PATCH_PC_YG2, "Scripts", "EditorScr", "Editor", "Icons");

        public static string PATCH_PC_ICON_YG2 => Path.Combine(PATCH_PC_ICONS, "IconPluginYG2.png");
        public static string PACH_ASSETS_ICON_YG2 => Path.Combine(PATCH_ASSETS_YG2, "Scripts", "EditorScr", "Editor",
            "Icons", "IconPluginYG2.png");
#endif
    }
}