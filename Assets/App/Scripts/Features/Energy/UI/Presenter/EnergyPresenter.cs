...
namespace App.Scripts.Features.Energy.UI.Presenter
{
    public class EnergyPresenter : IInitializable, ICleanupable
    {
        ...
        {
            _energyProvider.OnEnergyChanged += UpdateUI;
        ...
        {
            _energySliderUI.UpdateUI(_energyProvider.CurrentEnergy, _energyProvider.Config.MaxEnergy);
        }
